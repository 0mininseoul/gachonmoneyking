...
DECLARE
    ...
    -- Vietnamese (24)
    vn_nicknames text[] := array['Linh_Cute', 'Huy_Gachon', 'Nam_BunCha', 'Thao_Pink', 'Dung_Kun', 'Giang_Smile', 'Son_HN', 'Mai_Berry', 'Quynh_Nho', 'Long_Vina', 'Vy_Vy', 'Hieu_Kaka', 'Trang_Trang', 'Tung_Tung', 'Phuong_Hana', 'Lan_Vina', 'Khoa_Gachon', 'Minh_Chef', 'Binh_Nguyen', 'Duy_Duy', 'Khang_Khang', 'Anh_Anh', 'Oanh_Oanh', 'Viet_Viet'];
    ...
    -- Japanese (3)
    ja_nicknames text[] := array['Kento_jp', 'Yuka_Sato', 'Haru_jp'];
    ja_realnames text[] := array['Kento Sato', 'Yuka Tanaka', 'Haruto Watanabe'];
    
    -- Chinese (12)
    zh_nicknames text[] := array['Xiao_Wang', 'Gachon_Panda', 'JingJing', 'Yu_Yu', 'Lin_Lin', 'A_Xin', 'Momo_zh', 'Wu_Wu', 'Yang_Yang', 'Zhao_Zhao', 'Xu_Xu', 'Sun_Sun'];
    ...
    -- Mongolian (2)
    mn_nicknames text[] := array['Temu_Mn', 'Khulan_Kh'];
    mn_realnames text[] := array['Temulen Bat-Erdene', 'Khulan Altangerel'];
    
    -- Uzbek (3)
    uz_nicknames text[] := array['Anvar_Uz', 'Dil_Karim', 'Jasur_G'];
