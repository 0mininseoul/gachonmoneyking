...
-- Insert 44 dummy users with highly realistic nicknames (24 Vietnamese, 3 Japanese, 12 Chinese, 2 Mongolian, 3 Uzbek)
DO $$
DECLARE
    new_uid uuid;
    i integer;
    ...
    vn_nicknames text[] := array[
      'minh_anh_seoul', 'linh_kr_01', 'thi_huong_gachon', 'huy.phan.gachon', 
      'nam_vuhnai', 'phong_kr_life', 'thao_pinky', 'dung.kr.student', 
      'hai_seoul_life', 'giang_korea_life', 'son_tran_kr', 'mai_tran99', 
      'quynh_nhu_seoul', 'long_phm', 'vy_le_kr', 'hieu_hanoi_kr', 
      'trang_gachon', 'tung_seoul_life', 'phuong.gachon.univ', 'lan_bui_kr', 
      'khoa_anh_do', 'minh_chef_kr', 'binh_viet_kr', 'duy_duy_kr'
    ];
    ...
    -- Japanese (3)
    ja_nicknames text[] := array['kento_in_korea', 'yuka_seoul', 'haruto_gachon'];
    ja_realnames text[] := array['Kento Sato', 'Yuka Tanaka', 'Haruto Watanabe'];
    
    -- Chinese (12)
    zh_nicknames text[] := array[
      '在韩小张', '王王在首尔', '在韩留学生小李', '宇宇在加川', 
      '努力留学的闫闫', '阿俊在韩国', '琳琳_Korea', '小赵的在韩日记', 
      '小吴在首尔搬砖', '在韩搬砖小周', '徐徐_Seoul', '小孙在加川'
    ];
    ...
    -- Mongolian (2)
    mn_nicknames text[] := array['temuulen_kr', 'khulan_seoul'];
    mn_realnames text[] := array['Temulen Bat-Erdene', 'Khulan Altangerel'];
    
    -- Uzbek (3)
    uz_nicknames text[] := array['anvar_gachon', 'dilshod_kr', 'jasurbek_seoul'];
